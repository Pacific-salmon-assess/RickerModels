...
#saveRDS(posterior_simple, "../data/posterior_simple.rds")

posterior_simple <- readRDS("../data/posterior_simple.rds")
...
#saveRDS(posterior_ar, "../data/posterior_ar.rds")
posterior_ar <- readRDS("../data/posterior_ar.rds")
#plots
#plot_posteriors(posterior_simple$posteriors)
#posteriors of derived quantities -- the interesting ones
...
#saveRDS(posterior_recursive, "../data/posterior_recursive.rds")
posterior_recursive <- readRDS("../data/posterior_recursive.rds")
...
#saveRDS(posterior_surv, "../data/posterior_surv.rds")
posterior_surv <- readRDS("../data/posterior_surv.rds")
...
#saveRDS(posterior_survfec, "../data/posterior_survfec.rds")
posterior_survfec <- readRDS("../data/posterior_survfec.rds")
...
#saveRDS(posterior_survegg, "../data/posterior_survegg.rds")
posterior_survegg <- readRDS("../data/posterior_survegg.rds")
