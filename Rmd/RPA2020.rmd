...
```{r survfecpost_fig, echo=FALSE, fig.height = 7, fig.width = 9, fig.cap = "Figure. Posterior probability distributions for Ricker with survival as a covariate."}
...
```{r tablesurvfev, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
