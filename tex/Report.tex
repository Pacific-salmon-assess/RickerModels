...
In this model, the productivity parameter was disentangled into survival up to age 2, $surv_{a\leq2}$, and the remaining survival and fecundity effects, $\alpha$. Since survival data was missing for one year, that year was excluded from the analysis
